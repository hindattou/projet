...
class Auth(tk.Toplevel):
    def __init__(self, master):
        ...
        self.pwd.grid(row=1, column=1, padx=10)

        ttk.Button(self, text="Connexion", command=self.login).grid(
            row=2, column=0, pady=10
        )
        ttk.Button(self, text="Créer un compte", command=self.register).grid(
